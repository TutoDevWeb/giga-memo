 ...
 */
final class Version20260225104640 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE faqs ADD layer_type VARCHAR(255) DEFAULT \'layer_one\' NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE faqs DROP layer_type');
    }
}
